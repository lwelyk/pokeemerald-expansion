...
const struct Tileset gTileset_CrystalGuardians =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_CrystalGuardians,
    .palettes = gTilesetPalettes_CrystalGuardians,
    .metatiles = gMetatiles_CrystalGuardians,
