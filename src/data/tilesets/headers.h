...
const struct Tileset gTileset_GalarGeneral =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_GalarGeneral,
    .palettes = gTilesetPalettes_GalarGeneral,
    .metatiles = gMetatiles_GalarGeneral,
    .metatileAttributes = gMetatileAttributes_GalarGeneral,
    .callback = NULL,
};
