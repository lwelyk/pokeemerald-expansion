...
const u16 gMetatiles_custom[] = INCBIN_U16("data/tilesets/primary/custom/metatiles.bin");
const u16 gMetatileAttributes_custom[] = INCBIN_U16("data/tilesets/primary/custom/metatile_attributes.bin");
