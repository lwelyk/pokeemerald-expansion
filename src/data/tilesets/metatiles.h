...
const u16 gMetatiles_GalarGeneral[] = INCBIN_U16("data/tilesets/primary/galar_general/metatiles.bin");
const u16 gMetatileAttributes_GalarGeneral[] = INCBIN_U16("data/tilesets/primary/galar_general/metatile_attributes.bin");
