...
//Johto Map States
#define VAR_INTRO_STATE                                  0x40F7 // Used for the intro sequences. 0 = Nothing. 1 = Got Pokegear. 2 = Got Starter. 3 = Met Mr. Pokemon. 4 = Got call about robbery. 5 = Fought Rival. 6 = Got Pokedex
